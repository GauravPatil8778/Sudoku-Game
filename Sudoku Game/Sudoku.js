...
function checkCorrect(seltile) {
    ...
    return solution.charAt(seltile.id) === seltile.textContent;
}
...
function endGame() {
    ...
    if (lives === 0 || timeRemaining === 0) {
        ...
        alert("Game Over! You lost. Would you like to try again?");
    } else {
        id("lives").textContent = "You Won!!";
        alert("Congratulations! You won! Would you like to play again?");
    }

    if (confirm("Would you like to play again?")) {
        startGame(); // Restart the game if user clicks "OK"
    } else {
        // Optionally, handle exiting or redirecting to another page
